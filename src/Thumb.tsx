import { useState, useMemo, FC, Fragment, CSSProperties } from "react";
...
const Thumb: FC<ThumbProps> = ({ index, photo, width, height, hideIcons, showLightbox, showInfo, saveFavorite, favoriteStatus }) => {
    ...
    }, [collection, photo, index, favoriteStatus, mouseOver, showInfo, saveFavorite])
